...
export default function Products() {
  ...
  return (
    <>
      <Helmet>
        <title>Coffee Vending Machine Price Chennai | Kofeetek</title>
        <meta name="description" content="Looking for the best coffee vending machine price Chennai? Kofeetek offers affordable, high-quality coffee vending machines for offices, hotels, and businesses with installation, maintenance, and reliable support." />
        <meta name="keywords" content="coffee vending machine price Chennai, office coffee vending machine Chennai, instant coffee vending machine Chennai, coffee machine price in Chennai" />
        <link rel="canonical" href="https://www.kofeetek.in/products" />
      </Helmet>
